...
class UnnamedBehaviourTree
{
                ...
                (
                    ((
                        ...
                        (
                            ...
                            (IterateUntilSuccessDecorator(Collection: Global.TargetCollection, Output: out Tree.Unit), true)
                        ) &&
                        GetGameTime(Output: out Global.PrevTime)
                    ), true) &&
                    ((
    ...
    async Task<bool> GarenAtBaseHealAndBuy()
    {
        ...
        (
            ...
            (
                ...
                (
                    (
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "1054") &&
                        TestUnitAICanBuyItem(ItemID: "1054") &&
                        UnitAIBuyItem(ItemID: "1054")
                    ) ||
                    (
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "1001") &&
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "3009") &&
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "3117") &&
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "3020") &&
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "3006") &&
                        TestUnitAICanBuyItem(ItemID: "3111") &&
                        UnitAIBuyItem(ItemID: "1001")
                    ) ||
                    (
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "3105") &&
                        (
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "1028") &&
                                TestUnitAICanBuyItem(ItemID: "1028") &&
                                UnitAIBuyItem(ItemID: "1028")
                            ) ||
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "1029") &&
                                TestUnitAICanBuyItem(ItemID: "1029") &&
                                UnitAIBuyItem(ItemID: "1029")
                            ) ||
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "1033") &&
                                TestUnitAICanBuyItem(ItemID: "1033") &&
                                UnitAIBuyItem(ItemID: "1033")
                            ) ||
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "3105") &&
                                TestUnitAICanBuyItem(ItemID: "3105") &&
                    ...
                    (
                        ...
                        TestChampionHasItem(Unit: Global.Self, ItemID: "1001") &&
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "3009") &&
                        TestUnitAICanBuyItem(ItemID: "3009") &&
                        UnitAIBuyItem(ItemID: "3009")
                    ) ||
                    (
                        TestChampionHasItem(Unit: Global.Self, ItemID: "3105") &&
                        TestChampionHasItem(Unit: Global.Self, ItemID: "3009") &&
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "3068") &&
                        (
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "1011") &&
                                TestUnitAICanBuyItem(ItemID: "1011") &&
                                UnitAIBuyItem(ItemID: "1011")
                            ) ||
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "1031") &&
                                TestUnitAICanBuyItem(ItemID: "1031") &&
                                UnitAIBuyItem(ItemID: "1031")
                            ) ||
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "3068") &&
                                TestUnitAICanBuyItem(ItemID: "3068") &&
                    ...
                    (
                        ...
                        TestChampionHasItem(Unit: Global.Self, ItemID: "3009") &&
                        TestChampionHasItem(Unit: Global.Self, ItemID: "3068") &&
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "3026") &&
                        (
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "1029") &&
                                TestUnitAICanBuyItem(ItemID: "1029") &&
                            ...
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "3026") &&
                                TestUnitAICanBuyItem(ItemID: "3026") &&
                    ...
                    (
                        ...
                        TestChampionHasItem(Unit: Global.Self, ItemID: "3068") &&
                        TestChampionHasItem(Unit: Global.Self, ItemID: "3026") &&
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "3142") &&
                        (
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "1036") &&
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "3134") &&
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "3142") &&
                                TestUnitAICanBuyItem(ItemID: "1036") &&
                                UnitAIBuyItem(ItemID: "1036")
                            ) ||
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "3134") &&
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "3142") &&
                                TestUnitAICanBuyItem(ItemID: "3134") &&
                                UnitAIBuyItem(ItemID: "3134")
                            ) ||
                            (
                                !TestChampionHasItem(Unit: Global.Self, ItemID: "3142") &&
                                TestUnitAICanBuyItem(ItemID: "3142") &&
                    ...
                    (
                        ...
                        !TestChampionHasItem(Unit: Global.Self, ItemID: "2003") &&
                        TestUnitAICanBuyItem(ItemID: "2003") &&
    ...
    async Task<bool> GarenLevelUp()
    {
        ...
        (
            ...
            (
                (
                    TestUnitCanLevelUpSpell(Unit: Global.Self, SlotIndex: "3") &&
                ...
                (
                    TestUnitCanLevelUpSpell(Unit: Global.Self, SlotIndex: "1") &&
                    (
                        (
    ...
    async Task<bool> GarenAcquireTarget()
    {
        ...
        (
            (
                ...
                TestUnitIsVisible(Unit: Global.Self, TargetUnit: Global.AggroTarget) &&
                GarenDeaggroChecker() &&
        ...
        (
            (
                (
                    ...
                    TestUnitUnderAttack(Unit: Global.Self) &&
                    GetUnitMaxHealth(Unit: Global.Self, Output: out Tree.MaxHealth) &&
                    GetUnitCurrentHealth(Unit: Global.Self, Output: out Tree.Health) &&
                    (Tree.Health_Ratio = Tree.Health / Tree.MaxHealth, true) &&
                    Tree.Health_Ratio <= 0.25 &&
    ...
    async Task<bool> GarenKillChampion()
    {
        ...
        (
            ...
            (
                ...
                (
                    !TestUnitHasBuff(TargetUnit: Global.Self, CasterUnit: Tree., BuffName: "GarenBladestorm") &&
                    GarenCanCastAbility2() &&
                    await GarenCastAbility2()
                ) ||
                GarenAutoAttackTarget() ||
    ...
    bool GarenCanCastAbility0()
    {
        ...
        (
            ...
            Tree.Cooldown <= 0 &&
            TestCanCastSpell(Unit: Global.Self, Spellbook: "SPELLBOOK_CHAMPION", SlotIndex: "0")
        );
    }
    ...
    bool GarenCanCastAbility1()
    {
        ...
        (
            ...
            Tree.Cooldown <= 0 &&
            TestCanCastSpell(Unit: Global.Self, Spellbook: "SPELLBOOK_CHAMPION", SlotIndex: "1")
        );
    }
    ...
    bool GarenCanCastAbility2()
    {
        ...
        (
            ...
            Tree.Cooldown <= 0 &&
            TestCanCastSpell(Unit: Global.Self, Spellbook: "SPELLBOOK_CHAMPION", SlotIndex: "2")
        );
    }
    ...
    bool GarenCanCastAbility3()
    {
        ...
        (
            GetSpellSlotCooldown(Unit: Global.Self, Spellbook: "SPELLBOOK_CHAMPION", SlotIndex: "0", Output: out Tree.Cooldown) &&
            Tree.Cooldown <= 0 &&
            TestCanCastSpell(Unit: Global.Self, Spellbook: "SPELLBOOK_CHAMPION", SlotIndex: "3")
        );
    }
    ...
    bool GarenHeal()
    {
        ...
        (
            ...
            (
                Tree.HP_Ratio < 0.5 &&
                TestUnitAICanUseItem(ItemID: "2003") &&
